...
def prepare_seqs(loaded):
    ...
    print(np.unique(y_sequences,return_counts=True))
...
def eval(model_path, data_path):
    ...
    model.summary()
    preds = model.predict(   [X_val[:, :, modality_1_indices], X_val[:, :, modality_2_indices], X_val[:, :, modality_3_indices]])
...
if __name__ == '__main__':
    model_path = 'weights/multimodal_LSTM_768_UA.keras'
    data_path = 'data/val_org_split_UserAwkwardness.npz'
